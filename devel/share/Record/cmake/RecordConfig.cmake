...
if("TRUE" STREQUAL "TRUE")
  set(Record_SOURCE_PREFIX /home/dimitris/thesis/src/moveit)
  set(Record_DEVEL_PREFIX /home/dimitris/thesis/devel)
  set(Record_INSTALL_PREFIX "")
  set(Record_PREFIX ${Record_DEVEL_PREFIX})
else()
  set(Record_SOURCE_PREFIX "")
  set(Record_DEVEL_PREFIX "")
  set(Record_INSTALL_PREFIX /home/dimitris/thesis/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Record' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/moveit/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT Record_NUM_DUMMY_TARGETS)
      set(Record_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::Record::wrapped-linker-option${Record_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR Record_NUM_DUMMY_TARGETS "${Record_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::Record::wrapped-linker-option${Record_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND Record_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(Record_EXPORTED_TARGETS ${${Record_dep}_EXPORTED_TARGETS})
endforeach()
