...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/dimitris/thesis/src/FUEL/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/dimitris/thesis/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/dimitris/thesis/install)
...
if(NOT "/home/dimitris/thesis/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/FUEL/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
