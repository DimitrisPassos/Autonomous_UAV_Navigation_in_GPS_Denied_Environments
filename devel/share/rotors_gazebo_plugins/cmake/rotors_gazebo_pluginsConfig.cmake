...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/dimitris/thesis/src/sim/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/dimitris/thesis/devel)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/dimitris/thesis/install)
...
if(NOT "/home/dimitris/thesis/src/sim/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/dimitris/thesis/src/sim/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/sim/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
