...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/dimitris/thesis/src/m-explore/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/dimitris/thesis/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/dimitris/thesis/install)
...
if(NOT "/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/m-explore/map_merge/${idir}'.  ${_report}")
    endif()
