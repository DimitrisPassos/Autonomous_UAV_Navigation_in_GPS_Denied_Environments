...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /home/dimitris/thesis/src/FUEL/uav_simulator/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /home/dimitris/thesis/devel)
  ...
  set(local_sensing_node_INSTALL_PREFIX /home/dimitris/thesis/install)
...
if(NOT "/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(local_sensing_node_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/FUEL/uav_simulator/local_sensing/${idir}'.  ${_report}")
    endif()
