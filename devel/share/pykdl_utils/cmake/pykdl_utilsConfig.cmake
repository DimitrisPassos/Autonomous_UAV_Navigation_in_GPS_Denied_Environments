...
if("TRUE" STREQUAL "TRUE")
  set(pykdl_utils_SOURCE_PREFIX /home/dimitris/thesis/src/hrl-kdl/pykdl_utils)
  set(pykdl_utils_DEVEL_PREFIX /home/dimitris/thesis/devel)
  ...
  set(pykdl_utils_INSTALL_PREFIX /home/dimitris/thesis/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pykdl_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/hrl-kdl/pykdl_utils/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pykdl_utils_NUM_DUMMY_TARGETS)
      set(pykdl_utils_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pykdl_utils::wrapped-linker-option${pykdl_utils_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pykdl_utils_NUM_DUMMY_TARGETS "${pykdl_utils_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pykdl_utils::wrapped-linker-option${pykdl_utils_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pykdl_utils_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pykdl_utils_EXPORTED_TARGETS ${${pykdl_utils_dep}_EXPORTED_TARGETS})
endforeach()
