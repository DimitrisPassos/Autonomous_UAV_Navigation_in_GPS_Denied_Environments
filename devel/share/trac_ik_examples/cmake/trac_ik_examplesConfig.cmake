...
if("TRUE" STREQUAL "TRUE")
  set(trac_ik_examples_SOURCE_PREFIX /home/dimitris/thesis/src/trac_ik/trac_ik_examples)
  set(trac_ik_examples_DEVEL_PREFIX /home/dimitris/thesis/devel)
  ...
  set(trac_ik_examples_INSTALL_PREFIX /home/dimitris/thesis/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dimitris/thesis/src/trac_ik/trac_ik_examples/${idir}'.  ${_report}")
    endif()
    _list_append_unique(trac_ik_examples_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_date_time.so.1.71.0;orocos-kdl;nlopt_cxx")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT trac_ik_examples_NUM_DUMMY_TARGETS)
      set(trac_ik_examples_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::trac_ik_examples::wrapped-linker-option${trac_ik_examples_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR trac_ik_examples_NUM_DUMMY_TARGETS "${trac_ik_examples_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::trac_ik_examples::wrapped-linker-option${trac_ik_examples_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND trac_ik_examples_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${trac_ik_examples_dep}_FOUND)
      find_package(${trac_ik_examples_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${trac_ik_examples_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(trac_ik_examples_EXPORTED_TARGETS ${${trac_ik_examples_dep}_EXPORTED_TARGETS})
endforeach()
